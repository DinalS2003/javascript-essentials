...
function generateReport() {
    ...
    for (const condition in conditionsCount) {
        report.innerHTML +=
            `${condition}: ${conditionsCount[condition]}<br>`;
    }

    report.innerHTML +=
        "<br>Gender-Based Conditions:<br>";
    ...
    for (const gender in genderConditionsCount) {
        ...
        for (const condition in genderConditionsCount[gender]) {
            ...
            report.innerHTML +=
                `&nbsp;&nbsp;${condition}: ${genderConditionsCount[gender][condition]}<br>`;
        }
    }
}
    ...
    fetch('health_analysis.json')
        ...
        .then(data => {
            ...
            if (condition) {
                ...
                ${condition.symptoms.join(', ')}</p>

                <p><strong>Prevention:</strong>
                ${condition.prevention.join(', ')}</p>
